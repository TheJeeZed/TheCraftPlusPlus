package net.thejeezed.pandorium.init;
...
import net.thejeezed.pandorium.enums.tools.ToolStats;
import net.thejeezed.pandorium.item.custom.armor.CopperArmor;
import net.thejeezed.pandorium.item.custom.item.*;
