...
import net.thejeezed.pandorium.mob.animations.ModAnimationDefinitions;

public class SulphurZombieModel<T extends Entity> extends HierarchicalModel<T> {
	private final ModelPart main;
	private final ModelPart head;

	public SulphurZombieModel(ModelPart root) {
		this.main = root.getChild("main");
		this.head = main.getChild("waist").getChild("body").getChild("head");
	}
