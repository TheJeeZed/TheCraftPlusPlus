package net.thejeezed.pandorium;
...
import net.thejeezed.pandorium.enchant.ModEnchants;
import net.thejeezed.pandorium.creativetabs.CreativeTabs;
import net.thejeezed.pandorium.entity.ModEntities;
import net.thejeezed.pandorium.datagen.loot.ModLootModifiers;
import net.thejeezed.pandorium.init.*;
import net.thejeezed.pandorium.kiln.KilnScreen;
import net.thejeezed.pandorium.mob.client.StraferRenderer;
import net.thejeezed.pandorium.mob.client.SulphurZombieRenderer;
import net.minecraft.client.renderer.entity.ThrownItemRenderer;
import net.thejeezed.pandorium.recipe.ModRecipes;
import net.thejeezed.pandorium.util.ModEntitySpawn;
import org.slf4j.Logger;

@Mod(Pandorium.MOD_ID)
public class Pandorium {
    public static final String MOD_ID = "pandorium";
